                    ...
                    <td>
                      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                        <div style={{ width: "24px", height: "24px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                          <img 
                            src={`${import.meta.env.BASE_URL}assets/clubs/logos/${s.clubId}.png`} 
                            alt={s.clubShortName}
                        ...
                        <td>
                          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                            <div style={{ width: "20px", height: "20px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                              <img 
                                src={`${import.meta.env.BASE_URL}assets/clubs/logos/${entry.clubId}.png`} 
                                alt={entry.clubShort}
                                style={{ maxWidth: "100%", maxHeight: "100%", objectFit: "contain" }}
                                onError={(e) => {
                                  e.currentTarget.style.display = 'none';
                  ...
                  >
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                      <div style={{ width: "16px", height: "16px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <img 
                          src={`${import.meta.env.BASE_URL}assets/clubs/logos/${leader.clubId}.png`} 
                ...
                >
                  ...
                  <div style={styles.fixtureTeams}>
                    <div style={{
                      ...
                      <img src={`${import.meta.env.BASE_URL}assets/clubs/logos/${f.homeClubId}.png`} style={{ width: "24px", height: "24px", objectFit: "contain", marginLeft: "8px" }} onError={(e) => { e.currentTarget.style.display = 'none'; }} />
                    </div>
                    <div style={styles.fixtureScore}>
                      <span style={styles.scoreNum}>{f.result?.homeGoals}</span>
                    ...
                    <div style={{
                      ...
                      <img src={`${import.meta.env.BASE_URL}assets/clubs/logos/${f.awayClubId}.png`} style={{ width: "24px", height: "24px", objectFit: "contain", marginRight: "8px" }} onError={(e) => { e.currentTarget.style.display = 'none'; }} />
